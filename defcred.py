...
def logo():
	...
	logo = '''
              ...
              DEFCRED - Get default credentials easily
              Author: Navid Kagalwalla
	      Description: This tool is an easy way to search default credentials for routers, network devices, web applications etc.
